# Contributing to Flutter Flavor Manager

Thank you for considering contributing to Flutter Flavor Manager! This document provides guidelines and instructions for contributing.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/Abdallahabusnineh/flutter_flavor_manager.git
   cd flutter_flavor_manager
   ```
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/original/flutter_flavor_manager.git
   ```
